...
//		CET Switzerland, Biel Meantime UTC+1
			...
			if (time <= 9) {
				document.getElementsByClassName("beat")[0].innerHTML = "@00" + time;
			} else if (time <= 99) {
				document.getElementsByClassName("beat")[0].innerHTML = "@0" + time;
			} else document.getElementsByClassName("beat")[0].innerHTML = "@" + time;
